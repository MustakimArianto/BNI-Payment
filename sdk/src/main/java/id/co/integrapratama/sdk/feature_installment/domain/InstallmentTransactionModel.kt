...
data class InstallmentTransactionModel(
    val invoice: String,
    ...
    val qrisTapRefundInvoiceNo: String = "",
    val qrisTapRefundInvoiceDate: String = "",
)